...
try:
  ...
  def download_movie(message):
      ...
      def downmovie_util_2(user_movie_choice):
        ...
        with open('trimmed_movie_title_ls.pkl', 'rb') as f:
            trimmed_movie_title_ls = pickle.load(f)
        
        global movie_name_to_download
        movie_name_to_download = trimmed_movie_title_ls[user_movie_choicee-1]
        ...
        print_2 = f"I found the following qualities for {movie_name.text}"
      ...
      def downmovie_util(movie_name):
        ...
        try:
            ...
            with open('trimmed_movie_title_ls.pkl', 'wb') as f:
                pickle.dump(trimmed_movie_title_ls, f)
